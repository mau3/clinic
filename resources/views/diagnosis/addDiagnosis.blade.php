...
@section('content')
    ...
    <form method="POST" action="/diagnosis/addDiagnosis" enctype="multipart/form-data">
        {!! csrf_field() !!}
        ...
        <div class="container">
            ...
            <div class = "col-md-4">
                <label for="InputDate">содержание диагноза</label>
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit">Добавить диагноз</button>
            </div>
